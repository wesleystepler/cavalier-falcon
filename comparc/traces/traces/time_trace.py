...
def count_time_in(args, fh):
    ...
    for instruction in csv_reader:
        ...
        if last_instruction != None:
            ...
            if args.load_use_hazard and forward_from_last and args.stall:
                stall += 1
    ...
    return {
        ...
        'delay': load_use_delay + branch_delay + stall,
        'cycles': num_instructions + load_use_delay + branch_delay + stall,
...
def main():
    ...
    parser.add_argument('--stall', action='store_true', dest='stall', help='Add a stall')
