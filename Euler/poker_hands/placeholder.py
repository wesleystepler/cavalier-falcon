# I realized that the logic I'm using for the functions in this poker program 
# Aren't where they're supposed to be. I'm keeping the functions here because I should be
# able to recycle this logic for later use, but they need to be moved 
